...
public class App {
    ...
    public static void main(String args[]) {
        ...
        while (!isOpcaoValida(opcao)) {
            ...
            opcao = JOptionPane.showInputDialog(null,
                    "Opção inválida:  1: Cadastro / 2: Consultar / 3: Exclusão / 4: Alteração / 5: Sair",
                    "Cadastro Cliente", JOptionPane.INFORMATION_MESSAGE);
        }
        ...
        while (isOpcaoValida(opcao)) {
            if (isOpcaoSair(opcao)) {
                ...
                String dados = JOptionPane.showInputDialog(null,
                        "Digite os dados do cliente separados por vígula, conforme exemplo: Nome, CPF, Telefone, Endereço",
    ...
    private static void sair() {
        JOptionPane.showMessageDialog(null, "Até Logo - Obrigado", "Cadastro Cliente - Encerrado", JOptionPane.INFORMATION_MESSAGE);
        System.exit(0);
    }
